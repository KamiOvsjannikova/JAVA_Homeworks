...
public class ArrayListWorkUtil {
    ...
    //Для поиска максимуму можно использовать встроенный метод класса Math
    ...
    public List<Integer> test2(List<Integer> list) {
       ...
       //Так как список является ссылочным типом данных, то не нужно возвращать оригинал
        //если Вы измените оригинал здесь, то за пределами этого метода он тоже изменится
